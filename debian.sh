...
wget https://github.com/MFDGaming/debian-in-termux/raw/master/rootfs-${ARCHITECTURE}.tar.xz -q -O debian.tar.gz 
...
proot --link2symlink tar -xf $cur/debian.tar.gz --exclude='dev'||:
...
printf "\x1b[38;5;214m[${time1}]\e[0m \x1b[38;5;83m[Installer thread/INFO]:\e[0m \x1b[38;5;87m The installation has been completed! You can now launch Ubuntu with ./startdebian.sh\n"
printf "\e[0m"
